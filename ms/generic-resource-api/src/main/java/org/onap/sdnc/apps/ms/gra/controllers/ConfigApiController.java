...
public class ConfigApiController implements ConfigApi {
     ...
     *         <p>
     *         HttpStatus.BAD_REQUEST (400) if {@code serviceInstanceId} does
     *         not exist, unmarshalling Service Data from the database fails,
     *         there is no VNF data for {@code vnfId}, or writing Service Data
     *         back to the database fails.
     */
    @Override
