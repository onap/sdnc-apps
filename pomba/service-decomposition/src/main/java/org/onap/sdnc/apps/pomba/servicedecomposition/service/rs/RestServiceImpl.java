...
import static org.onap.sdnc.apps.pomba.servicedecomposition.exception.DiscoveryException.Error.GENERAL_FAILURE;
    ...
    public Response getContext(HttpServletRequest request,
        ...
        try {
            ...
            if ((fromAppId == null) || fromAppId.trim().isEmpty()) {
                throw new DiscoveryException(DiscoveryException.Error.MISSING_HEADER, Status.BAD_REQUEST, ONAPLogConstants.Headers.PARTNER_NAME);
            }
