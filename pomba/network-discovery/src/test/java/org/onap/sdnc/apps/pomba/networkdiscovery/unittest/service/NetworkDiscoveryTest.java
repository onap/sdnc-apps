...
public class NetworkDiscoveryTest {
    ...
    public void testVerifyAppId() throws Exception {
        ...
        Response response = this.service.findbyResourceIdAndType(this.httpRequest, V1, null, this.transactionId,
    ...
    public void testVerifyNotificationUrl() throws Exception {
        // no X-FromAppId header
        List<String> resourceIds = Arrays.asList(UUID.randomUUID().toString());
        Response response = this.service.findbyResourceIdAndType(this.httpRequest, V1, APP, this.transactionId,
    ...
    public void testDiscoverVserver() throws Exception {
        ...
        Response response = this.service.findbyResourceIdAndType(this.httpRequest, V1, APP, null, this.requestId,
        ...
        String notificationJson = events.get(0).getRequest().getBodyAsString();
